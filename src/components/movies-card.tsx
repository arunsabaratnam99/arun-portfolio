          ...
          movies.map((movie, idx) => (
            <div key={idx} className="relative inline-flex">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex gap-3 group hover:cursor-crosshair"
              ...
              >
                {movie.image && (
                  <img
                    ...
                    loading="lazy"
                    decoding="async"
                    className="w-12 h-16 object-cover rounded transition-transform duration-300 group-hover:scale-110 group-hover:shadow-lg"
                    onError={(e) => {
                ...
                <div className="flex flex-col">
                  <div className="font-geist-mono text-xs text-white group-hover:underline">
                    {movie.title}
                  </div>
                  {movie.rating && (
              ...
              {hoveredMovie === idx && (
                <div className={`absolute left-0 bg-neutral-800 text-white text-xs px-2 py-1 rounded z-50 pointer-events-none border border-neutral-700 animate-in fade-in duration-200 max-w-[calc(100%-1rem)] truncate ${
                  idx === 0
